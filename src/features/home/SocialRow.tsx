...
export function SocialRow() {
  return (
    <motion.div
      ...
      className="mx-auto mt-6 max-w-[15rem] border-t border-gray-200 pt-5 text-center lg:mr-0 lg:ml-auto lg:text-right dark:border-gray-800"
    >
      <p className="text-xs font-semibold tracking-wide text-gray-500 uppercase dark:text-gray-400">
        Me suivre
      </p>
      <div className="mt-3 flex justify-center gap-2.5 lg:justify-end">
